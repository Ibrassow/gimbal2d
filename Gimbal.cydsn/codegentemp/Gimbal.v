// ======================================================================
// Gimbal.v generated from TopDesign.cysch
// 05/20/2022 at 21:10
...
module I2C_v3_50_1 (
	...
	cy_clock_v1_0
		#(.id("b39cc671-119b-4665-a4c5-feaa0dc9698c/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("67ecd2d5-4385-4bf4-9d79-b5b80dcb99fc/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_DelSig_v3_30_5 (
	...
	cy_clock_v1_0
		#(.id("581357e0-4d98-4589-89b6-2a9d19e7bd71/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("581357e0-4d98-4589-89b6-2a9d19e7bd71/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0800a26d-5fe2-4cad-8f3b-d908876ea6ef"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("58c8ae49-c106-4388-b87d-f5edeca71513"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("0bb5de2d-c42f-4c9d-a1ff-f4a1521b27b0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__SmallServo_net;
	wire [0:0] tmpFB_0__SmallServo_net;
	wire [0:0] tmpIO_0__SmallServo_net;
	wire [0:0] tmpINTERRUPT_0__SmallServo_net;
	electrical [0:0] tmpSIOVREF__SmallServo_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SmallServo
		 (.oe(tmpOE__SmallServo_net),
		  .y({Net_287}),
		  .fb({tmpFB_0__SmallServo_net[0:0]}),
		  .io({tmpIO_0__SmallServo_net[0:0]}),
		  .siovref(tmpSIOVREF__SmallServo_net),
		  .interrupt({tmpINTERRUPT_0__SmallServo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SmallServo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LargeServo_net;
	wire [0:0] tmpFB_0__LargeServo_net;
	wire [0:0] tmpIO_0__LargeServo_net;
	wire [0:0] tmpINTERRUPT_0__LargeServo_net;
	electrical [0:0] tmpSIOVREF__LargeServo_net;

	cy_psoc3_pins_v1_10
		#(.id("0e661d5f-ec8d-435b-b7ae-9ff021c34dea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LargeServo
		 (.oe(tmpOE__LargeServo_net),
		  .y({Net_326}),
		  .fb({tmpFB_0__LargeServo_net[0:0]}),
		  .io({tmpIO_0__LargeServo_net[0:0]}),
		  .siovref(tmpSIOVREF__LargeServo_net),
		  .interrupt({tmpINTERRUPT_0__LargeServo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LargeServo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("aaca040e-09ef-4a3b-8638-9d2fbdbcd462"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cbeda77e-4cfa-4464-8a2e-77b022864fc0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b4357170-9db3-4ef4-a271-bb2a8deeecd3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b65c6fca-8eb9-486c-af6c-8a6e34ee0543"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("881a575c-06d2-421e-ba90-a54c199db685"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6e67fab4-7977-4aa0-93b9-f55b23cdfd55"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("871e698c-a175-4943-a741-4235de272f06"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam Timer_Audio.InterruptOnCapture = 1;
    defparam Timer_Audio.InterruptOnTC = 1;
    defparam Timer_Audio.Resolution = 16;
    defparam Timer_Audio.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("eff6470f-d616-4cc5-85b3-ac971ed638bc"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(4),
		  .period("0"),
		  .is_direct(0),
